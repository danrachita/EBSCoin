...
This means one can have an always-on ebsd instance running, and another local ebsd/ebs-qt instance which connects to this node and receives blocks from it.
