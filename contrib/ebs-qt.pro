...
RESOURCES += src/qt/ebs.qrc src/qt/ebs_locale.qrc

TRANSLATIONS += src/qt/locale/ebs_bg.ts \
                src/qt/locale/ebs_de.ts \
                src/qt/locale/ebs_en.ts \
                src/qt/locale/ebs_es.ts \
                src/qt/locale/ebs_fi.ts \
                src/qt/locale/ebs_fr.ts \
                src/qt/locale/ebs_it.ts \
                src/qt/locale/ebs_ja.ts \
                src/qt/locale/ebs_pl.ts \
                src/qt/locale/ebs_pt.ts \
                src/qt/locale/ebs_ru.ts \
                src/qt/locale/ebs_sk.ts \
                src/qt/locale/ebs_sv.ts \
                src/qt/locale/ebs_vi.ts \
                src/qt/locale/ebs_zh_CN.ts \
                src/qt/locale/ebs_zh_TW.ts
