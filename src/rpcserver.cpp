...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EBS features */
        {"ebs", "masternode", &masternode, true, true, false},
        {"ebs", "listmasternodes", &listmasternodes, true, true, false},
        {"ebs", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ebs", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ebs", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ebs", "masternodedebug", &masternodedebug, true, true, false},
        {"ebs", "startmasternode", &startmasternode, true, true, false},
        {"ebs", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ebs", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ebs", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ebs", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ebs", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ebs", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ebs", "mnbudget", &mnbudget, true, true, false},
        {"ebs", "preparebudget", &preparebudget, true, true, false},
        {"ebs", "submitbudget", &submitbudget, true, true, false},
        {"ebs", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ebs", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ebs", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ebs", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ebs", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ebs", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ebs", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ebs", "checkbudgets", &checkbudgets, true, true, false},
        {"ebs", "mnsync", &mnsync, true, true, false},
        {"ebs", "spork", &spork, true, true, false},
        {"ebs", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ebs", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ebsd, or the -server option to ebs-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"EBS Alert\" admin@foo.com\n"),
...
{
    return "> ebs-cli " + methodname + " " + args + "\n";
}
