                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("EBS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EBS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ebs: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About EBS Core"), this);
    aboutAction->setStatusTip(tr("Show information about EBS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EBS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EBS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EBS addresses"));
    ...
    openAction->setStatusTip(tr("Open a EBS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the EBS Core help message to get a list with possible EBS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("EBS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EBS network", "", count));
}
...
{
    QString strTitle = tr("EBS Core"); // default title
