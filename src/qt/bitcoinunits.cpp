...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case EBS:
            return QString("EBS");
        case mEBS:
            return QString("Milli-EBS (1 / 1" THIN_SP_UTF8 "000)");
        case uEBS:
            return QString("Micro-EBS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
