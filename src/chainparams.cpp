...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        (0, uint256("0x00000327b95e50728cbfbcdf16546951e788b0f34db7e40d6c9fb44ba56cfece"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1523115106, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("039985762875bfa2f4412929582207db73822092f90b029e3def6f0f4e12139bf1");
        nDefaultPort = 51582;
        bnProofOfWorkLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000"); // EBS starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // EBS: 1 day
        nTargetSpacing = 150;  // EBS: 150 seconds
        nLastPOWBlock = 3000;
        nMaturity = 20;
        ...
        */
        ...
        const char* pszTimestamp = "U.S. News & World Report April 6, 2018 U.S. Slaps Sanctions on Putin Cronies";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1523115106;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 6885303;
...
//        convertSeed6(vFixedSeeds, pnSeed6_main, ARRAYLEN(pnSeed6_main));
        ...
        nStartMasternodePayments = 300; // Start after 300 blocks
    }
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // EBS: 1 day
        nTargetSpacing = 5 * 60;  // EBS: 5 minutes
        nLastPOWBlock = 200;
        nMaturity = 15;
...
//        assert(hashGenesisBlock == uint256("0x000005b346bed6717056a1e45e6cd371e7be408ca19220445b5cd608925dbf12"));
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet EBS script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet EBS BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet EBS BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet EBS BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // EBS: 1 day
        nTargetSpacing = 1 * 60;        // EBS: 1 minutes
