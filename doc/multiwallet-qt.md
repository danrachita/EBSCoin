...
In order to support loading of multiple wallets in ebs-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ebs.cpp.
...
Changes to ebs.cpp
----------------------
ebs.cpp is the entry point into ebs-qt, and as such, will require some minor modifications to provide hooks for
